...
namespace FinalCry
{
    public partial class marketingAdd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                cmd = new MySqlCommand("insert into marketing(name,email,number,doj,role,level) values(@a1,@a2,@a3,@a4,@a5,@a6)", con);
